...
@test "tasks - forward to sdk doctoolchain" {
    ...
    assert_equal "$(mock_get_call_args "${mock_doctoolchain}")" ". tasks --group doctoolchain --warning-mode=none --no-daemon -Dfile.encoding=UTF-8 -Dgradle.user.home=${DTC_ROOT}/.gradle"
}
